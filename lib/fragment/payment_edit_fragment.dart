...
class PaymentEditFragment extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState createState() => _PaymentEditFragmentState();
}

class _PaymentEditFragmentState extends ConsumerState<PaymentEditFragment> {
